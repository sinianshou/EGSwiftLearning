...
class DataBuilder: NSObject {
    ...
    class func LongestValidParenthesesData()->[String]{
        return[
            "(()",  //output 2
            ")()())",   //output 4
            "()(()",  //output 2
    ...
    class func MaxProfitData()->[([Int],Int)]{
        return[
        ([2,4,1],2),    //output 2
        ([3,2,6,5,0,3],2),    //output 2
        ([6,1,3,2,4,7],2),    //output 7
        ([1,2],1),    //output 1
        ]
    }
